...
func initConstantEnv() {
	...
	// Non-stream upstream responses are buffered by many provider adaptors.
	constant.MaxUpstreamResponseBodyMB = GetEnvOrDefault("MAX_UPSTREAM_RESPONSE_BODY_MB", 128)
