...
func TestOaiResponsesToChatBufferedStreamHandlerRejectsEmptyAssistantResult(t *testing.T) {
	body := strings.Join([]string{
		`data: {"type":"response.completed","response":{"id":"resp_empty","model":"gpt-test","status":"completed","usage":{"input_tokens":1,"output_tokens":0,"total_tokens":1}}}`,
		`data: [DONE]`,
		``,
	}, "\n")
