...
var defaultModelRatio = map[string]float64{
	...
	// Kimi prices are published in RMB per 1M tokens. RMB converts a
	// RMB-per-1K-token price to the gateway's model-ratio unit.
	"kimi-k3":                            0.0200 * RMB,
	"kimi-k2.7-code":                     0.0065 * RMB,
	"kimi-k2.7-code-highspeed":           0.0130 * RMB,
	"kimi-k2.6":                          0.0065 * RMB,
	"kimi-k2.5":                          0.0040 * RMB,
	"moonshot-v1-8k":                     0.0020 * RMB,
	"moonshot-v1-32k":                    0.0050 * RMB,
	"moonshot-v1-128k":                   0.0100 * RMB,
	"moonshot-v1-8k-vision-preview":      0.0020 * RMB,
	"moonshot-v1-32k-vision-preview":     0.0050 * RMB,
	"moonshot-v1-128k-vision-preview":    0.0100 * RMB,
...
var defaultCompletionRatio = map[string]float64{
	...
	"kimi-k2.6":                               27.0 / 6.5,
	"kimi-k2.5":                               21.0 / 4.0,
	"moonshot-v1-8k":                          10.0 / 2.0,
	"moonshot-v1-32k":                         20.0 / 5.0,
	"moonshot-v1-128k":                        30.0 / 10.0,
	"moonshot-v1-8k-vision-preview":           10.0 / 2.0,
	"moonshot-v1-32k-vision-preview":          20.0 / 5.0,
	"moonshot-v1-128k-vision-preview":         30.0 / 10.0,
}
