...
func TestConvertRequestResponsesToGeminiRejectsUnrepresentableCustomTool(t *testing.T) {
	info := &convmeta.Values{
	...
	assert.Equal(t, []types.RelayFormat{types.RelayFormatOpenAIResponses}, info.ConversionChain)
}
