...
func TestOpenAIToClaudeConversionPreservesExplicitZeroReasoningBudget(t *testing.T) {
	converted, err := OpenAIChatRequestToClaudeMessages(nil, testClaudeDefaultMeta(), dto.GeneralOpenAIRequest{
...
func TestOpenAIToClaudeConversionPreservesDeveloperStrictToolsAndStructuredOutput(t *testing.T) {
	strict := true
	request, err := OpenAIChatRequestToClaudeMessages(nil, testClaudeDefaultMeta(), dto.GeneralOpenAIRequest{
		Model: "claude-sonnet-4",
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			assert.NotPanics(t, func() {
				_, err := OpenAIChatRequestToClaudeMessages(nil, testClaudeDefaultMeta(), dto.GeneralOpenAIRequest{
					Model: "claude-sonnet-4",
					Tools: []dto.ToolCallRequest{{
						Type: "function",
						Function: dto.FunctionRequest{
