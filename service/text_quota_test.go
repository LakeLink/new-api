...
func TestCalculateTextQuotaSummaryBillsGeminiGroundingFromActualQueries(t *testing.T) {
	...
	require.Equal(t, "google_search", summary.ToolSurchargeItems[0].Name)
	require.Equal(t, 2, summary.ToolSurchargeItems[0].Count)
	require.Equal(t, 14.0, summary.ToolSurchargeItems[0].Price)
...
func TestCalculateTextQuotaSummaryUsesGeminiMapsPromptPrice(t *testing.T) {
	...
	require.Len(t, summary.ToolSurchargeItems, 1)
	require.Equal(t, "google_maps", summary.ToolSurchargeItems[0].Name)
	require.Equal(t, 1, summary.ToolSurchargeItems[0].Count)
	require.Equal(t, 25.0, summary.ToolSurchargeItems[0].Price)
...
func TestResponsesFileSearchSettlementUsesModelPriceOverride(t *testing.T) {
	...
	require.Len(t, summary.ToolSurchargeItems, 1)
	require.Equal(t, dto.BuildInToolFileSearch, summary.ToolSurchargeItems[0].Name)
	require.Equal(t, 2, summary.ToolSurchargeItems[0].Count)
	require.Equal(t, 9.0, summary.ToolSurchargeItems[0].Price)
