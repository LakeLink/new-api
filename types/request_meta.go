...
type TokenCountMeta struct {
	...
	ImageInputTokens  int                `json:"image_input_tokens,omitempty"`  // Estimated image input tokens reserved before the request
	ImageOutputTokens int                `json:"image_output_tokens,omitempty"` // Estimated image output tokens reserved before the request
