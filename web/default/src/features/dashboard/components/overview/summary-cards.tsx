...
export function SummaryCards() {
  ...
  const burnForecastTimeRange = useMemo(
  ...
  const burnForecastQuery = useQuery({
    queryKey: [
      'dashboard',
      'overview',
      'balance-burn-forecast',
      burnForecastTimeRange.start_timestamp,
      burnForecastTimeRange.end_timestamp,
    ],
    queryFn: async () =>
      getUserQuotaDates({
        start_timestamp: burnForecastTimeRange.start_timestamp,
        end_timestamp: burnForecastTimeRange.end_timestamp,
        default_time: 'hour',
      }),
    staleTime: 60 * 1000,
  })
  ...
  const burnForecastValue = burnForecastQuery.isLoading
    ? t('Calculating...')
    : getBurnForecastValue(burnForecast, t)
  const burnForecastDetail = burnForecastQuery.isLoading
